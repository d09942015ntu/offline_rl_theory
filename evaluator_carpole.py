...
from pds_kernel import (PDSKernel, kernel_gaussian, kernel_linear,
                        phi_tuple, phi_array, phi_linear, phi_quadratic)
...
def main():
    ...
    parser.add_argument('--phi', type=str,  choices=['phi_array', 'phi_linear','phi_quadratic'], default='phi_array')
